...
<html>
<head>
    <title>MobiComparison | Customer Login</title>
...
<body bgcolor="#f1f1f1">
     <!-- Responsive header -->
   <div class="header">
  <a href="http://sumitkp.xyz/notifier_desktop/customer_login.php" class="logo">MobiComparison | Customer Login</a>
  ...
  <h2>Login Form</h2>
  <p>For Testing:<br>
  <b>Username:</b>sum1<br>
  <b>Password:</b>sum2<br></p>
